...
int main (void)
{
	...
	printf("Matriz de transicion Canonica -> Beta:\n");
	for(i=0; i<vBeta; i++)
	{
		for(j=0; j<dimension; j++)
		{
	...
	printf("Matriz de transicion Beta -> Alfa:\n");
	for(i=0; i<vAlfa; i++)
	{
		for(j=0; j<vBeta; j++)
		{
	...
	MultiplicaMatrices(resultados,vAlfa,vBeta,C,dimension);
	...
	printf("Matriz de transicion Alfa -> Beta:\n");
	for(i=0; i<vBeta; i++)
	{
		for(j=0; j<vAlfa; j++)
		{
	...
	//Multiplicar Matriz de Transicion por Vector
	printf("\nVector en base Alfa:");
	MultiplicaMatrices(resultadosA,vBeta,vAlfa,C,dimension);
}
